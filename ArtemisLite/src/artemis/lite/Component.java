...
public class Component extends Square {
     ...
     * @param costForLanding - the cost for any player that isn't the owner landing on this component
     * @param componentSystem - the ArtemisSystem object that this component belongs to
     */
